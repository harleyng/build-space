        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <Select value={feeName} onValueChange={setFeeName}>
              ...
              <SelectContent>
                {category &&
                  feeNamesByCategory[category]?.map((name) => (
            ...
            <p className="text-sm text-muted-foreground">Chọn tên phí.</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Chọn tần suất thanh toán phí này.
            </p>
          </div>

          <div className="space-y-3">
            <Label>
              Phí này có bắt buộc không? <span className="text-red-500">*</span>
            </Label>
            <RadioGroup value={isRequired} onValueChange={setIsRequired}>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="included" id="included" />
                <Label htmlFor="included" className="font-normal cursor-pointer">
                  Bao gồm trong tiền thuê cơ bản
                </Label>
              </div>
              <div className="flex items-center space-x-2">
